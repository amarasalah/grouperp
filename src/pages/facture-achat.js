// Facture Achat Page - unique product per invoice, no duplicates across all modules
import { getAll, add, update, remove, getSettings, getNextNumber, deleteFactureWithReglements, getInvoicedAchatProductIds } from '../data/store.js';
...
export async function renderFactureAchat() {
  ...
  async function openForm() {
    const invoicedIds = await getInvoicedAchatProductIds();
